...
static var LEVELS: Array[Dictionary] = [
	# ── LEVEL 1: THE CURSED FOREST ──────────────────────────────────────
	{
		...
		"enemy_types": ["melee", "fast", "flying"],
		"enemy_weights": { "melee": 0.50, "fast": 0.30, "flying": 0.20 },
		"environment": {
	...
	# ── LEVEL 2: THE DEAD WORKS ─────────────────────────────────────────
	{
		...
		"enemy_types": ["melee", "ranged", "fast", "digger", "flying"],
		"enemy_weights": { "melee": 0.30, "ranged": 0.25, "fast": 0.20, "digger": 0.15, "flying": 0.10 },
		"environment": {
	...
	# ── LEVEL 3: THE DEEP WARRENS ───────────────────────────────────────
	{
		...
		"enemy_types": ["melee", "fast", "exploder", "splitter", "digger"],
		"enemy_weights": { "melee": 0.20, "fast": 0.30, "exploder": 0.20, "splitter": 0.15, "digger": 0.15 },
		"environment": {
	...
	# ── LEVEL 4: THE OUTER SANCTUM ──────────────────────────────────────
	{
		...
		"enemy_types": ["melee", "ranged", "tank", "fast", "exploder", "flying", "splitter"],
		"enemy_weights": { "melee": 0.15, "ranged": 0.18, "tank": 0.15, "fast": 0.15, "exploder": 0.12, "flying": 0.12, "splitter": 0.13 },
		"environment": {
	...
	# ── LEVEL 5: TEMPLE FLOOR 1 - HALL OF ECHOES ────────────────────────
	{
		...
		"enemy_types": ["melee", "ranged", "tank", "fast", "exploder", "flying", "splitter", "digger"],
		"enemy_weights": { "melee": 0.12, "ranged": 0.14, "tank": 0.16, "fast": 0.12, "exploder": 0.12, "flying": 0.12, "splitter": 0.12, "digger": 0.10 },
		"environment": {
	...
	# ── LEVEL 6: TEMPLE FLOOR 2 - THE CRIMSON NAVE ──────────────────────
	{
		...
		"enemy_types": ["melee", "ranged", "tank", "fast", "exploder", "flying", "splitter", "digger"],
		"enemy_weights": { "melee": 0.10, "ranged": 0.12, "tank": 0.16, "fast": 0.10, "exploder": 0.14, "flying": 0.14, "splitter": 0.13, "digger": 0.11 },
		"environment": {
	...
	# ── LEVEL 7: TEMPLE FLOOR 3 - THE THRONE OF THE NAMELESS ────────────
	{
		...
		"enemy_types": ["melee", "ranged", "tank", "fast", "exploder", "flying", "splitter", "digger"],
		"enemy_weights": { "melee": 0.10, "ranged": 0.10, "tank": 0.14, "fast": 0.10, "exploder": 0.14, "flying": 0.16, "splitter": 0.15, "digger": 0.11 },
		"environment": {
