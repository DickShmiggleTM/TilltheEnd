...
##
## Map types:
##   "open"   — outdoor wide maps with object scatter, terrain, tree barriers (no ceiling)
##   "walled" — indoor walled maps with rooms, doors, locks, keys, items
##
...
static var LEVELS: Array[Dictionary] = [
	# ── LEVEL 1: THE CURSED FOREST ──────────────────────────────────────
	{
		...
		"map_type": "open",
		"map_script": "res://scripts/map/open_map_generator.gd",
		"map_config": {
			"grid_size": 80,
			"prop_type": "forest",
	...
	# ── LEVEL 2: THE DEAD WORKS ─────────────────────────────────────────
	{
		...
		"map_type": "walled",
		"map_script": "res://scripts/map/walled_map_generator.gd",
		"map_config": {
			"grid_size": 64,
			"prop_type": "industrial",
			"door_density": 0.45,
			"lock_density": 0.35,
			"item_scatter_density": 0.06,
			"room_count_min": 10,
			"room_count_max": 16,
		},
	...
	# ── LEVEL 7: TEMPLE FLOOR 3 - THE THRONE OF THE NAMELESS ────────────
	{
		...
		"map_config": {
			"grid_size": 80,
			"prop_type": "temple_final",
			"door_density": 0.60,
			"lock_density": 0.50,
			"item_scatter_density": 0.09,
			"room_count_min": 16,
			"room_count_max": 24,
		},
